    ...
    public class OnboardingController : Controller
    {
        ...
        public ActionResult SignUp([Bind(Include="ID,Name,AdminConsented")] Tenant tenant)
        {
            ...
            string authorizationRequest = String.Format(
                "https://login.microsoftonline.com/common/oauth2/authorize?response_type=code&client_id={0}&resource={1}&redirect_uri={2}&state={3}",
                 Uri.EscapeDataString(CustomConfigurationManager.AppSettings["ida:ClientID"]),
        ...
        public ActionResult ProcessCode(string code, string error, string error_description, string resource, string state)
        {
            ...
            else
            {
                ...
                ClientCredential credential = new ClientCredential(CustomConfigurationManager.AppSettings["ida:ClientID"],
                                                                   CustomConfigurationManager.AppSettings["ida:Password"]);
