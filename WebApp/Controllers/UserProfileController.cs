...
namespace TodoListWebApp.Controllers
{
    ...
    public class UserProfileController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            try
            {
                ...
                ActiveDirectoryClient graphClient = new ActiveDirectoryClient(
                    ...
                    async () => await getTokenForGraphAsync(tenantID, signedInUserID, userObjectID, clientId, appKey, graphResourceID));
        ...
        private async Task<string> getTokenForGraphAsync(string tenantID, string signedInUserID, string userObjectID, string clientId, string appKey, string graphResourceID)
        {
